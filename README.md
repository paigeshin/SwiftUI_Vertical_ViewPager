# TabController using UIViewRepresentable, Infinite Scrolling as Options 
...
struct VerticalPageViewController<Page: View>: UIViewControllerRepresentable {
    ...
    let enableInfiniteScrolling: Bool
    
    init(
        _ pages: [Page],
        currentPageIndex: Binding<Int>,
        enableInfiniteScrolling: Bool = true
    ) {
        self.pages = pages
    ...
    func updateUIViewController(_ pageViewController: UIPageViewController, context: Context) {
        pageViewController.setViewControllers(
            [context.coordinator.controllers[self.currentPageIndex]],
            direction: .forward,
            animated: true)
    }
    ...
    class Coordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
        ...
        func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
            ...
            if self.parent.enableInfiniteScrolling {
                if index == 0 {
                    return self.controllers.last
                }
                return self.controllers[index - 1]
            }
            if index - 1 >= 0 && self.controllers.count > 0 {
                return self.controllers[index - 1]
            }
            return nil
        }
        ...
        func pageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
            ...
            if index + 1 < self.controllers.count && self.controllers.count > 0 {
                return self.controllers[index + 1]
            }
            return nil
        }
...
# TabContrller using UIViewRepresentable, Infinite Scrolling 
